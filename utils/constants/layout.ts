...
export const PAGE_MENU = [
  ...
  { id: 23, to: '/stock-out/packing/packing-note-list', root: '/stock-out/packing', label: 'Packing list', parentId: 22, isLast: true },
  { id: 24, to: '/stock-take', label: 'Stock Take', parentId: 2,  isLast: true },
