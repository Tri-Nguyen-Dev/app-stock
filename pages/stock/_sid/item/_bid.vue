...
class ItemDetail extends Vue {
  ...
  get itemLocation() {
    return this.itemDetail.location?.name
  }

  get itemWarehouse() {
    return this.itemDetail.warehouse?.name
  }

  get sellerName() {
    return this.itemDetail.seller?.name
  }

  get sellerEmail() {
    return this.itemDetail.seller?.email
  }

  get sellerPhone() {
    return this.itemDetail.seller?.phone
  }
