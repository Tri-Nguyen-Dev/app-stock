<template lang="pug">
  .grid.mx-0
    div.w-5rem
    .col-2.bg-white.p-4.mt-5.border-round-top.min-h-screen
      ...
      .grid.flex.my-5
        ...
        .col-fixed
          Button.border-0.p-0.h-2rem.w-2rem.justify-content-center.surface-200.shadow-none
...
const nsStoreSubmission = namespace('submission/store-submission')
