    ...
    .container-fluid.h-custom
      .row.d-flex.justify-content-center.align-items-center.h-100
        ...
        form.col-md-8.col-lg-6.col-xl-4.offset-xl-1
          h4.mt-1.mb-5.pb-1.text-test AIRTAG SYSTEM
          .form-outline.mb-4
            InputText.form-c.form-control-lg(v-model="loginUser.userName", placeholder="Enter user name")
          .form-outline.mb-3
            InputText.form-c.form-control-lg(type="password", v-model="loginUser.password", placeholder="Enter password")
