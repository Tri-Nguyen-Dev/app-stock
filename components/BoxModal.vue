...
div
  .mt-3
    b-modal#box-modal(
      ...
      @ok='handleOk',
      @hidden='clearAddModal'
    )
      b-form(@submit.stop.prevent='onSubmit')
        b-form-group#example-input-group-1(
          label='Name',
        ...
        .row
          .col-md-6.mb-3
            b-form-group#example-input-group-1(
              ...
              b-form-input#row-input(
                name='row-input',
                v-model='dataForm.supplier',
                :state='validateState("supplier")',
                aria-describedby='row-live-feedback'
              )
          ...
          .col-md-6.mb-3
            b-form-group#example-input-group-1(
              ...
              b-form-input#column-input(
                name='column-input',
                v-model='dataForm.status',
                :state='validateState("status")',
                aria-describedby='column-live-feedback'
              )
...
export default class BoxModal extends Vue {
  ...
  handleSubmitModal() {
    this.$emit('handleSubmitModal', this.dataForm)
  }
