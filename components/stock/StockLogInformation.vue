            ...
            .grid
              .col-fixed.flex.align-items-center
                div.surface-200.p-2.border-round
                  ...
                  .icon--large.icon-incoming.bg-blue-500(v-show='item.description === "REQUEST_TO_IMPORT_BOX"')
              .col
                ...
                div.font-semibold.text-lg(v-show='item.description === "REQUEST_TO_IMPORT_BOX"') Incoming Quantity
